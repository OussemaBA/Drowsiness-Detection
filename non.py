...
# SciPy package so we can compute the Euclidean distance between facial landmarks points in
# the eye aspect ratio calculation

from imutils.video import VideoStream
from imutils import face_utils
from threading import Thread

# import the Thread class so we can play our alarm in a separate thread from the main thread to ensure
# our script doesn’t pause execution while the alarm sounds
...
# input audio file to be used as an alarm.
